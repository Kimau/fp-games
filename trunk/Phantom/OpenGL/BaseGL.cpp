...
void WinGLengine::Load(HINSTANCE _hInstance, HWND _hWnd, UINT _height, UINT _width)
{
	//----------------------------------
	//	Check for Dud
	//----------------------------------
...
bool WinGLengine::CreatePixelFormat(HDC _hdc)
{
    ...
    _pfd.nVersion = 1;
    _pfd.dwFlags = PFD_SUPPORT_OPENGL | PFD_DOUBLEBUFFER; 
    _pfd.dwLayerMask = PFD_MAIN_PLANE;
    _pfd.iPixelType = PFD_TYPE_RGBA;
    _pfd.cColorBits = m_Depth;
    _pfd.cDepthBits = m_Depth;
    _pfd.cAccumBits = 0;
    _pfd.cStencilBits = 0;
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
//=========================================================================================
//	Swaps Buffers and Draws Screen
//=========================================================================================
void WinGLengine::SwapGL_Buffers()
{
