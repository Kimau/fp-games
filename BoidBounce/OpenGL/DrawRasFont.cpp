...
: m_id(0),
  m_engine(WinGLengine(0,0,0,0)),
  m_height(0)
{}
//=========================================================================================
// Creates Raster Font
//=========================================================================================
BGLRasterFont::BGLRasterFont(const WinGLengine& _engine, int _height, const char* _font)
: m_engine(_engine), m_height(_height)
{
...
//	Draw Font
//=========================================================================================
void BGLRasterFont::Render(UINT x, UINT y, const char* _format, ...)
{
	//---------------------------------
	//  Generate Text
	//---------------------------------
