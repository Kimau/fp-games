...
#define OBJECT_LOCAL        0x4160			// The Local Axis
...
struct t3DObject 
{
	...
	CVert		*pVerts;		// The object's vertices
	CNorm		*pNormals;		// The object's normals
	CTexCoord	*pTexVerts;		// The texture's UV coordinates
...
private:
	...
	void ReadAxis(t3DObject *pObject, tChunk *);
